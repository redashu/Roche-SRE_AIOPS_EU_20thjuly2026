...
REGION = "eu-central-1"
MODEL_ID = "arn:aws:bedrock:eu-central-1:992382386705:application-inference-profile/aexzy32u2wwn"

# --- GUARDRAIL CONFIGURATION ---
GUARDRAIL_ID = "j566h88zq4n9"  # e.g., 'a1b2c3d4e5f6'
GUARDRAIL_VERSION = "DRAFT"               # Use "DRAFT" or a specific version like "1"

guardrail_config = {
    "guardrailIdentifier": GUARDRAIL_ID,
    "guardrailVersion": GUARDRAIL_VERSION,
    "trace": "enabled"                    # Set to "enabled" to inspect block reasons in response metadata
}
...
"""
    ...
    response = client.converse(
        ...
        # Attach guardrail configuration
...
while True:
    ...
    # Check if Guardrail intercepted the input or output
    if response.get("stopReason") == "guardrail_intervened":
        print("\n[!] Notice: Guardrail Intervened")
